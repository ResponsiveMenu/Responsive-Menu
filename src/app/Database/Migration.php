...
class Migration{
  ...
  protected function migrateVersion2Options()
  {
    ...
    $new_options = [
      ...
      'menu_links_height' => $old_options['RMLinkHeight'] ? $old_options['RMLinkHeight'] : '',
      'submenu_arrow_height' => $old_options['RMLinkHeight'] ? $old_options['RMLinkHeight'] : '',
      'submenu_arrow_width' => $old_options['RMLinkHeight'] ? $old_options['RMLinkHeight'] : '',
