...
export default function InserterModal(props) {
	const { isInserterOpen, setInserterOpen, value, onChange = noop } = props;
	...
	return (
		<Modal
			...
			title={__('Icon Library', 'responsive-menu')}
					...
					<div className="icon-inserter__content-header">
						...
						<div className="icon-controls">
							<div className="icon-controls__size">
								<span>
									{__('Preview size', 'responsive-menu')}
								</span>
								<RangeControl
									min={24}
									max={72}
