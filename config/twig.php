...
$shortcode_filter = new Twig_SimpleFilter('shortcode', function($string) {
    return do_shortcode($string);
});

$translate_filter = new Twig_SimpleFilter('translate', function($string, $key) {
    // WPML Support
...
$build_menu = new Twig_SimpleFunction('build_menu', function($options) use ($translate_filter) {
