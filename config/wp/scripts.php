...
if(isset($_GET['page']) && $_GET['page'] == 'responsive-menu'):
    add_action('admin_enqueue_scripts', function() {
        ...
        wp_register_style('responsive-menu-base-css', plugin_dir_url(dirname(dirname(__FILE__))) . 'public/css/admin/base.css', false, RESPONSIVE_MENU_VERSION );
        wp_enqueue_style('responsive-menu-base-css');

        wp_register_style('responsive-menu-additional-css', plugin_dir_url(dirname(dirname(__FILE__))) . 'public/css/admin/additional.css', false, RESPONSIVE_MENU_VERSION );
        ...
        wp_register_script('responsive-menu-base-js', plugin_dir_url(dirname(dirname(__FILE__))) . 'public/js/admin/base.js', 'jquery', RESPONSIVE_MENU_VERSION );
        ...
        wp_register_script('responsive-menu-additional-js', plugin_dir_url(dirname(dirname(__FILE__))) . 'public/js/admin/additional.js', 'jquery', RESPONSIVE_MENU_VERSION );
        wp_localize_script(
