...
function rmp_hamburger_type_animation_options() {
    ...
    $type = array (
        ...
        '3dx'        => __( '3DX','responsive-menu-pro' ),
        '3dx-r'      => __( '3DX Reverse','responsive-menu-pro' ),
        '3dy'        => __( '3DY','responsive-menu-pro' ),
        '3dy-r'      => __( '3DY Reverse','responsive-menu-pro' ),
        'arrow'      => __( 'Arrow','responsive-menu-pro' ),
        'arrow-r'    => __( 'Arrow Reverse','responsive-menu-pro' ),
        'arrowalt'   => __( 'Arrow Alt','responsive-menu-pro'),
        'arrowalt-r' => __( 'Arrow Alt Reverse','responsive-menu-pro' ),
        'collapse'   =>  'Collapse',
