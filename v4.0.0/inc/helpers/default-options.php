...
function rmp_get_default_options() {
    ...
    $default_options = [
        ...
        "menu_name" => "Default menu settings", 
        ...
        "menu_current_item_background_colour" => "rgba(63,63,63,0)", 
        ...
        "menu_search_box_border_radius" => "5", 
        "menu_search_box_text_colour" => "#333", 
        "menu_search_box_background_colour" => "#fff", 
        "menu_search_box_placeholder_colour" => "#938f8f", 
        "menu_search_box_border_colour" => "#ffffff", 
