        ...
        foreach ($rmp_themes as $theme_name) {
            ?><div class="rmp-theme-title ">
				...
				<span class="item-controls">
					<?php
                    if ($in_customizer) {
                        ?><a theme-name="<?php echo esc_attr($theme_name); ?>" class="rmp-theme-apply" theme-type="template"><?php esc_html_e('Apply', 'responsive-menu'); ?></a><?php
                    } else {
                        ?><input type="radio" class="rmp-theme-option" name="menu_theme" id="<?php echo esc_attr($theme_name); ?>" value="<?php echo esc_attr($theme_name); ?>" theme-type="template"/>
							<label theme-name="<?php echo esc_attr($theme_name); ?>" class="rmp-theme-use" for="<?php echo esc_attr($theme_name); ?>"><?php esc_html_e('Use', 'responsive-menu'); ?></label><?php
                    } ?>
				</span>
			</div><?php
        }
				...
				<div class="rmp-item-card">
					...
					<div class="rmp-item-card-backside">
						<div class="rmp-item-card_contents">
							<h4> <?php esc_html_e($theme['name'], 'responsive-menu'); ?> </h4>
						</div>
						<div class="rmp-item-card_action">
							<?php
                                if (! empty($theme['demo_link'])) {
                                    ...
                                    } ?><a href="<?php echo esc_url($link); ?>" alt="<?php echo esc_attr($theme['name']); ?>" target="_blank" rel="noopener" class="button"><?php esc_html_e('View Demo', 'responsive-menu'); ?></a><?php
                                } ?>
            ...
            $id = 'rmp-theme-' . preg_replace('/\s+/', '', $theme['theme_name']); ?>
				<li class="rmp_theme_grid_item">
					...
					<label class="rmp-item-card" for="<?php echo esc_attr($id); ?>">
						<figure class="rmp-item-card_image">
							<img src="<?php echo esc_url($theme['theme_preview_url']); ?>" alt="<?php esc_html_e($theme['theme_name'], 'responsive-menu'); ?>" loading="lazy"/>
						</figure>
						<div class="rmp-item-card-backside">
							<div class="rmp-item-card_contents">
								<h4> <?php esc_html_e($theme['theme_name'], 'responsive-menu'); ?> </h4>
							</div>
							<div class="rmp-item-card_action">
								<?php
                                if (! empty($theme['demo_link' ])) {
                                    ...
                                    } ?><a href="<?php echo esc_url($link); ?>" alt="<?php echo esc_attr($theme['theme_name']); ?>" target="_blank" rel="noopener" class="button"><?php esc_html_e('View Demo', 'responsive-menu'); ?></a><?php
                                }
            if ($in_customizer) {
                ?><button class="button btn-blue rmp-theme-apply" theme-name="<?php echo esc_html($theme['theme_name']); ?>" theme-type="downloaded" ><?php esc_html_e('Apply', 'responsive-menu'); ?></button><?php
            } ?>
							</div>
						</div>
					</label>
