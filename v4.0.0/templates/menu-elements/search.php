...
<li class="rmp-accordion-item rmp-order-item">
    <div class="rmp-accordion-title rmp-order-item-title">
        ...
        <span class="item-controls">
            ...
            <input type="checkbox" data-toggle="search" value="on" id="rmp-item-order-search" class="no-updates toggle item-type" name="menu[items_order][search]" <?php if (! empty($options['items_order']['search'])) {
